...
This package is _**VERY**_ much work-in-progress and while a lot of the foundation is standardized the exposed API is subject to change, as it's focused around my specific usage.
